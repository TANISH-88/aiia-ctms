        ...
        <section className="mb-8">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <button
              ...
              className="rounded-[5px] border border-slate-200 bg-white p-5 text-left shadow-[0_1px_3px_rgba(15,23,42,0.03)] transition hover:border-[#1d5edb]"
            >
              <div className="flex items-center justify-between">
                <p className="text-sm text-slate-500">Audit Log</p>

                <span className="h-3 w-3 rounded-full bg-[#1d5edb]" />
              </div>

              <p className="mt-5 text-[16px] font-semibold tracking-[-0.02em] text-[#17243b]">
        ...
        <section className="mt-10">
          <div className="mb-5 flex items-end justify-between">
            ...
            <button
              ...
              className="hidden cursor-pointer text-sm font-medium text-[#3d9673] transition hover:text-[#277556] sm:block"
            >
              View all studies →
            </button>
          </div>
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-5">
                          ...
                          <button
                            ...
                            className="shrink-0 cursor-pointer text-sm font-medium text-[#3d9673] transition hover:text-[#277556]"
                          >
                            Review →
                          </button>
                        </div>
