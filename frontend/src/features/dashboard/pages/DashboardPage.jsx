          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            ...
            <div className="rounded-[6px] border border-[#dfe7ef] bg-white p-5 shadow-[0_1px_2px_rgba(19,52,80,0.08)]">
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-[#5d7187]">
                  Active studies
                </p>
            ...
            <div className="rounded-[6px] border border-[#dfe7ef] bg-white p-5 shadow-[0_1px_2px_rgba(19,52,80,0.08)]">
              ...
              <p className="mt-4 text-[28px] font-semibold tracking-[-0.04em] text-[#16324f]">
                ...
                <span className="text-[22px] text-[#5d7187]">
            ...
            <button
              ...
              className="group rounded-[6px] border border-[#dfe7ef] bg-white p-5 text-left shadow-[0_1px_2px_rgba(19,52,80,0.08)] transition-all duration-200 hover:border-[#d93c42] hover:shadow-[0_4px_12px_rgba(19,52,80,0.12)]"
            >
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-[#5d7187]">
                  Overdue SAEs
