...
export default function AdverseEventDetailPage() {
  ...
  if (loading) {
    return <div className="flex min-h-screen items-center justify-center bg-[#f6f8fc]"><p className="text-sm text-slate-500">Loading adverse event...</p></div>;
  }

  if (error && !event) {
    return <div className="min-h-screen bg-[#f6f8fc] px-6 py-10"><div className="rounded-[5px] border border-red-200 bg-white p-6"><h2 className="text-lg font-semibold text-slate-900">Unable to load adverse event</h2><p className="mt-2 text-sm text-red-600">{error}</p></div></div>;
  }
      ...
      <div className="min-h-screen bg-[#f6f8fc] px-5 py-8 text-[#16233b] sm:px-8 lg:px-10">
        <div className="w-full">
          ...
          <div className="mt-5 border-b border-slate-200 pb-6">
            ...
            <h1 className="mt-2 text-2xl font-semibold text-[#17243b]">AE/SAE Report Review</h1>
            <p className="mt-2 text-sm text-slate-500">{event.is_serious ? "Serious Adverse Event" : "Adverse Event"}</p>
          </div>
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <section className="rounded-[5px] border border-slate-200 bg-white p-6 shadow-[0_1px_3px_rgba(15,23,42,0.03)]">
              ...
              <dl className="space-y-4 text-sm">
                ...
                <div><dt className="font-medium text-slate-700">Description</dt><dd className="mt-1 text-slate-600">{event.description}</dd></div>
    ...
    <div className="min-h-screen bg-[#f6f8fc] px-5 py-8 text-[#16233b] sm:px-8 lg:px-10">
      <div className="w-full">
        ...
        <div className="mt-5 border-b border-slate-200 pb-6">
          ...
          <h1 className="mt-2 text-2xl font-semibold text-[#17243b]">Adverse Event Details</h1>
          <p className="mt-2 text-sm text-slate-500">{event.is_serious ? "Serious Adverse Event" : "Adverse Event"}</p>
        </div>
