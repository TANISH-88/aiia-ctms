...
export default function Sidebar({
  ...
  return (
    <aside
      className={`fixed inset-x-0 top-14 bottom-0 left-0 z-70 flex w-66 flex-col overflow-y-auto overscroll-contain border-r border-[#dfe7ef] bg-white transition-transform duration-300 lg:static lg:inset-y-0 lg:z-auto lg:translate-x-0 lg:overflow-visible lg:transition-[width] lg:duration-300 ${
        isMobileOpen
          ? "translate-x-0"
          : "-translate-x-full"
      } ${
