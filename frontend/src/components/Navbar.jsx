    ...
    items: [
      {
        title: "Apply",
        description:
          "Submit your details to participate in a clinical study.",
      },
    ],
  },
];
    ...
    <>
      ...
      >
        <div className="relative mx-auto w-full max-w-[1800px] px-4 sm:px-5 lg:px-6 xl:px-8">
          ...
          {/* NAVBAR */}
          <nav className="mx-auto flex h-[88px] min-h-[88px] w-full max-w-[390px] items-center justify-between gap-3 py-0 xl:max-w-none xl:justify-around">
                          ...
                          {item.label === "Participate" ? (
                            ...
                            <>
                              <div className="grid gap-8 md:grid-cols-[1fr_1fr_1fr] md:items-start">
                                ...
                                <div className="flex min-h-full flex-col">
                                  {(
                                    menuPanels[item.label]?.tertiary || []
                                  ).map(
                                    (entry, index) => (
                                      <div key={entry.title}>
                                        <div className="py-2 first:pt-0">
            ...
            <div className="max-h-[calc(100vh-88px)] space-y-2 overflow-y-auto overscroll-contain border-t border-[#1b5ec7]/15 bg-white px-2 py-3 xl:hidden">
              ...
              <div className="grid gap-2 border-t border-[#dfe7ef] pt-3">
                ...
                {isAuthenticated ? (
                  ...
                  /* BOOK A DEMO REMOVED FROM MOBILE TOO */
                  <button
                    type="button"
                    onClick={() => {
                      setIsOpen(false);
